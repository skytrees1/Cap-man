...
class red(p.sprite.Sprite):
    def __init__(self):
        ...
        self.images_list = []
        self.images_list.append(p.image.load('assets/images/blinky/blinky_right_1.png').convert_alpha())
        self.images_list.append(p.image.load('assets/images/blinky/blinky_right_2.png').convert_alpha())
        self.images_list.append(p.image.load('assets/images/blinky/blinky_down_1.png').convert_alpha())
        self.images_list.append(p.image.load('assets/images/blinky/blinky_down_2.png').convert_alpha())
        self.images_list.append(p.image.load('assets/images/blinky/blinky_left_1.png').convert_alpha())
        self.images_list.append(p.image.load('assets/images/blinky/blinky_left_2.png').convert_alpha())
        self.images_list.append(p.image.load('assets/images/blinky/blinky_up_1.png').convert_alpha())
        self.images_list.append(p.image.load('assets/images/blinky/blinky_up_2.png').convert_alpha())
